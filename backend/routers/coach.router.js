...
coachRouter.put('/matches/:matchId', authenticate.verifyUser, authenticate.verifyCoach, coachController.updateMatchRanks);
coachRouter.put('/practiceSessions/:practiceSessionId', authenticate.verifyUser, authenticate.verifyCoach, coachController.updatePracticeSessionRanks);
